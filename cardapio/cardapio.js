...
function preencherTabela() {
    dados.forEach((e, i) => {
        ...
        detalhes.innerHTML = `<button class="cabec" onclick="abrirModal('${i}')">Mais Info</button>`;
...
function abrirModal(i){
    ...
    document.querySelector("#preco").innerHTML = `Valor: ${dados[i].preco}`;
    document.querySelector("#descricao").innerHTML = `Descrição: ${dados[i].descricao}`;
}
